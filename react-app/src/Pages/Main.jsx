                        ...
                        <Row>
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                    ...
                                    <span>Сообщений: {items.messages_count}</span>
                                </div>
                            </Col>
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                    ...
                                    <span>Чатов: {items.chats_count}</span>
                                </div>
                            </Col>
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                    ...
                                    class="bi bi-people" viewBox="0 0 16 16" style={{marginRight:'2%'}}>
                                        ...
                                        1.09-2.904.243-.294.526-.569.846-.816ZM4.92 10A5.493 
                                    ...
                                    <span>Участников: {items.users_count}</span>
                                </div>
                            </Col>
                        </Row>
                    </Container>
