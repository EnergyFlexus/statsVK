                ...
                <Row style={{marginTop:'auto', backgroundColor:'#212529', padding:'1%'}}>
                    <Container fluid style={{color: "#FFFFFF", height: '100%'}}>
                        <Row>
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16" style={{marginRight:'1%'}}>
                            ...
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-chat-heart" viewBox="0 0 16 16" style={{marginRight:'1%'}}>
                            ...
                            <Col className='ms-5'>
                                <div style={{padding:'1%'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16" style={{marginRight:'1%'}}>
